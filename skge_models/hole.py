import numpy as np
from skge_models.base import Model
from skge_models.util import grad_sum_matrix, unzip_triples, ccorr, cconv
from skge_models.param import normless1
import skge_models.actfun as af
...
class HolE(Model):
    ...
    def _scores_r(self, s, o, p):
        return np.sum(self.R * ccorr(self.E[s], self.E[o]), axis=1)
