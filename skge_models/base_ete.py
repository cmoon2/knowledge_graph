...
class Config(object):
    ...
    def __init__(self, model, trainer):
        print("skge_models/base.py: class Config(object): def __init__(self, model, trainer)")
        self.model = model
        self.trainer = trainer

    def __getstate__(self):
        #print("skge_models/base.py: class Config(object): def __getstate__(self)")
        return {
            'model': self.model,
...
class Model(object):
    ...
    - _pairwise_gradients(self, pxs, nxs) for PairwiseStochasticTrainer_ETE
    """

    def __init__(self, *args, **kwargs):
        print("skge_models/base.py: class Model(object): def __init__(self, *args, **kwargs)")
...
class StochasticTrainer_ETE(object):
    """
    ...
    def _optim(self, xys):
        ...
        #xys: [((0, 1, 0), 1.0), ((2, 3, 1), 1.0), ((4, 5, 2), 1.0), ...
        ...
        for self.epoch in range(1, self.max_epochs + 1):
            #print("Epoch = " + str(self.epoch) + " / " + str(self.max_epochs))
            # shuffle training examples
            self._pre_epoch()
            shuffle(idx)
            #print("[Done] _pre_epoch() and shuffle(idx)")
...
class PairwiseStochasticTrainer_ETE(StochasticTrainer_ETE):
    """
    ...
    def __init__(self, *args, **kwargs):
        super(PairwiseStochasticTrainer_ETE, self).__init__(*args, **kwargs)
    ...
    def _process_batch(self, xys):
        ...
        grads = self.model._pairwise_gradients(pxs, nxs, self.kg_model)
